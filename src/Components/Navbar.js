        ...
        <div className="collapse navbar-collapse" id="navbarText">
          <ul className="navbar-nav mr-auto ml-5">
            <li className="nav-item ">
              <Link to="/brand?bname=all">
                {" "}
                <button className="nav-link btn btn-link">Shop all</button>
              </Link>
            </li>
            <li className="nav-item ">
              <Link to="">
                {" "}
                <button className="nav-link btn btn-link">Styles</button>
              </Link>
            </li>
            <li className="nav-item ">
              <Link to="/user/login">
            ...
            <li className="nav-item dropdown ">
              ...
              <div className="dropdown-menu">
                <Link to="/brand?bname=Adidas">
                  <button className="dropdown-item">Adidas</button>
                </Link>
                <Link to="/brand?bname=Nike">
                  {" "}
                  <button className="dropdown-item">Nike</button>
                </Link>
                <Link to="/brand?bname=Converse">
                  {" "}
                  <button className="dropdown-item">Converse</button>
                </Link>
              </div>
            </li>
            {localStorage.getItem("admin_token") ? (
              <li className="nav-item dropdown ">
                ...
                <div className="dropdown-menu">
                  <Link to="/admin/manageProducts">
                    <button className="dropdown-item">Manage Products</button>
                  </Link>
                  <Link to="/admin/manageUsers">
                    {" "}
                    <button className="dropdown-item">Manage Users</button>
                  </Link>
                  <Link to="/addproduct">
                    {" "}
                    <button className="dropdown-item">Add Products</button>
                  </Link>
                </div>
              </li>
            ) : (
              <li className="nav-item ">
                <Link to="/adminlogin">
                  {" "}
                  <button className="nav-link btn btn-link">Admin Login</button>
                </Link>
              </li>
            )}
          </ul>
